[![pipeline status](https://gitlab.com/aruw/controls/Legacy_2023/badges/develop/pipeline.svg)](https://gitlab.com/aruw/controls/Legacy_2023/-/commits/develop)
...
```
cd my-amazing-project/Legacy_2023-project
pipenv shell
# Build for hardware
scons build
# Run automated tests
...
1. Make sure you have VSCode opened in the folder `Legacy_2023` (**not
   `Legacy_2023-project`**)
...
1. Open the folder `aruw-Legacy_2023-project` in VSCode. Hit the debug tab on the left side or type
...
`/Legacy_2023-project/robot-type/robot_type.hpp` and change the macro defined in this file.
...
The below commands require that your working directory is `/Legacy_2023-project` (where the
